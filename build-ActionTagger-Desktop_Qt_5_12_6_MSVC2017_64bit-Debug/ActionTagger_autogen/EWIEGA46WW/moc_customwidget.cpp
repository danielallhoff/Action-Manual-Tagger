...
QT_MOC_LITERAL(1, 13, 16), // "somethingChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "QWidget*"
QT_MOC_LITERAL(4, 40, 7) // "changed"

    },
    "CustomWidget\0somethingChanged\0\0QWidget*\0"
    "changed"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->somethingChanged((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CustomWidget::*)(QWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomWidget::somethingChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::somethingChanged(QWidget * _t1)
{
