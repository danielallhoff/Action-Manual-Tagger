...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Subactions = new QLabel(centralwidget);
        Subactions->setObjectName(QString::fromUtf8("Subactions"));
        QPalette palette5;
...
#endif
        Subactions->setPalette(palette5);

        horizontalLayout_2->addWidget(Subactions);
